...
function findBySpecialization(specialization) {
    ...
    if (foundSpecialization) {
        document.getElementById('employeeDetails').innerHTML = `<p>${foundSpecialization.id}: ${foundSpecialization.name} - ${foundSpecialization.department} - ${foundSpecialization.specialization}</p>`;
    } else {
